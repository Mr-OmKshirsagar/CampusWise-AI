...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#030508] text-slate-100 flex flex-col relative overflow-hidden bg-ambient-mesh selection:bg-sky-500 selection:text-white">
      {/* Background Ambient Floating Orbs */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute -top-40 -left-40 w-[550px] h-[550px] bg-sky-500/10 rounded-full blur-[140px] animate-pulse-glow" />
        <div className="absolute top-1/3 -right-40 w-[600px] h-[600px] bg-purple-500/10 rounded-full blur-[150px] animate-float" />
        <div className="absolute -bottom-40 left-1/3 w-[650px] h-[650px] bg-emerald-500/10 rounded-full blur-[160px] animate-float-delayed" />
        <div className="absolute inset-0 grid-pattern opacity-35" />
      </div>

      <main className="flex-1 max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 py-8 sm:py-14 md:py-20 relative z-10 space-y-16 sm:space-y-24">
        {/* =========================================================================
           1. HERO SECTION
           ========================================================================= */}
        <section className="text-center max-w-4xl mx-auto space-y-5 sm:space-y-8">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full glass-badge-glow text-sky-300 text-[10px] sm:text-xs font-bold uppercase tracking-wider shadow-glass-sm animate-fade-in">
            <span className="w-2 h-2 rounded-full bg-sky-400 animate-pulse shadow-[0_0_8px_#38bdf8]" />
            <span>Official College RAG Platform • v2.0</span>
          </div>

          <h1 className="font-display text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-[1.12]">
            Official Campus Answers.{' '}
            <span className="bg-gradient-to-r from-sky-400 via-electric-400 to-cyber-400 bg-clip-text text-transparent block sm:inline">
              Zero Hallucinations.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 pt-2 w-full max-w-xs sm:max-w-md mx-auto">
            {isAuthenticated ? (
              <Link
                to="/chat"
                className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-gradient-to-r from-sky-500 via-electric-500 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 text-white font-bold text-xs sm:text-sm shadow-glow-blue flex items-center justify-center gap-2 transition-all hover:scale-105 active:scale-95"
              >
              ...
              <>
                ...
                <Link
                  to="/login"
                  className="w-full sm:w-auto px-6 py-3.5 rounded-2xl glass-panel-elevated hover:bg-white/[0.08] text-slate-200 hover:text-white font-bold text-xs sm:text-sm border border-white/[0.12] transition-all flex items-center justify-center gap-2"
                >
        ...
        <section className="space-y-6">
          <div className="text-center space-y-2">
            <span className="text-[10px] sm:text-xs uppercase font-bold text-sky-400 tracking-widest flex items-center justify-center gap-1.5">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 max-w-4xl mx-auto">
            {demoPrompts.map((item, idx) => (
              <button
                ...
                className={`px-3.5 py-2 rounded-2xl text-xs font-semibold transition-all duration-200 flex items-center gap-2 ${
              ...
              >
                ...
                <span className="truncate max-w-[200px] sm:max-w-[280px]">{item.query}</span>
              </button>
            ))}
          </div>

          {/* Sandbox Live Response Showcase Card */}
          <div className="max-w-4xl mx-auto glass-panel-elevated p-5 sm:p-8 rounded-3xl border border-white/[0.12] space-y-6 shadow-glass-lg relative overflow-hidden">
            {/* Student Query Simulated Input */}
            <div className="flex items-start gap-3.5 pb-5 border-b border-white/[0.08]">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-sky-600 to-indigo-600 text-white flex items-center justify-center shrink-0 shadow-glow-blue">
              ...
              <div className="space-y-3 flex-1">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2.5 py-0.5 rounded-full text-[9px] font-extrabold uppercase tracking-wider bg-emerald-500/15 text-emerald-300 border border-emerald-500/30 flex items-center gap-1">
                      <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                      100% Grounded
                    </span>
                  </div>

                  <span className="text-xs font-mono font-bold text-sky-400 bg-sky-500/10 px-2.5 py-0.5 rounded-full border border-sky-500/25">
                    {currentDemo.confidence}% Vector Confidence
                  </span>
                </div>

                <p className="text-xs sm:text-sm text-slate-200 leading-relaxed bg-white/[0.02] p-4 rounded-2xl border border-white/[0.06]">
                  {currentDemo.answer}
                </p>
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-xl glass-badge border-white/[0.1] text-xs">
                      <FileText className="w-3.5 h-3.5 text-sky-400" />
                      <span className="text-white font-medium truncate max-w-[200px]">
                        {currentDemo.source}
                      </span>
                      <span className="text-sky-400 font-mono text-[11px]">p.{currentDemo.page}</span>
                    </div>
                  </div>
                ...
                {showExcerptModal && (
                  <div className="mt-3 p-4 rounded-2xl glass-input border border-white/[0.1] text-xs text-slate-300 leading-relaxed font-sans animate-slide-up space-y-2">
                    ...
                    <p className="italic">"{currentDemo.excerpt}"</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <section className="space-y-6">
          <div className="text-center space-y-2">
            <span className="text-[10px] sm:text-xs uppercase font-bold text-purple-400 tracking-widest flex items-center justify-center gap-1.5">
        ...
        <section className="space-y-6">
          <div className="text-center space-y-2">
            <span className="text-[10px] sm:text-xs uppercase font-bold text-emerald-400 tracking-widest flex items-center justify-center gap-1.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {domains.map((domain, index) => (
              <div
                key={index}
                className="glass-card p-5 sm:p-6 rounded-3xl space-y-4 border-white/[0.08] relative group"
              >
        ...
        <section className="space-y-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5 sm:gap-5">
            {benchmarks.map((item, idx) => (
              <div
                key={idx}
                className="glass-panel-elevated p-4 sm:p-6 rounded-3xl border border-white/[0.1] text-center space-y-2 shadow-glass-md"
              >
                <div className="flex justify-center">
                  <GlassIcon icon={item.icon} variant={item.variant} size="xs" />
                </div>
                <div className="font-display text-xl sm:text-3xl font-extrabold text-white tracking-tight font-mono">
                  {item.value}
                </div>
                <div>
        ...
        {/* =========================================================================
           6. CTA BANNER
           ========================================================================= */}
        <section className="glass-panel-elevated p-8 sm:p-12 rounded-3xl sm:rounded-[2.5rem] border border-sky-500/30 text-center space-y-6 shadow-glow-blue relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-4">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                ...
                className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-gradient-to-r from-sky-500 via-electric-500 to-indigo-600 text-white font-bold text-xs sm:text-sm shadow-glow-blue hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-2"
              >
      ...
      {/* =========================================================================
         7. FOOTER
         ========================================================================= */}
      <footer className="border-t border-white/[0.08] glass-panel py-8 px-4 sm:px-8 mt-12 bg-[#030508]/90">
