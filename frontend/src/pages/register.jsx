  ...
  return (
    <div className="min-h-[calc(100dvh-4rem)] flex items-center justify-center p-4 sm:p-6 relative bg-ambient-mesh selection:bg-sky-500 selection:text-white overflow-hidden py-8 sm:py-12">
      ...
      <div className="w-full max-w-md space-y-6 relative z-10 animate-slide-up">
        ...
        <div className="glass-card p-2.5 rounded-2xl border-white/[0.08] flex items-center justify-between">
          <span className="text-[10px] font-bold uppercase tracking-wider text-slate-400 pl-2 flex items-center gap-1">
          ...
          <button
            ...
            className="py-1 px-3 rounded-xl glass-badge hover:bg-sky-500/20 text-[11px] font-semibold text-sky-300 border-sky-500/30 transition-all flex items-center gap-1 active:scale-95"
          >
                ...
                <button
                  ...
                  className={`py-2 rounded-xl text-xs font-semibold transition-all flex items-center justify-center gap-1.5 ${
                    role === 'student'
                      ...
                      : 'glass-badge text-slate-400 hover:text-white'
                  }`}
                >
