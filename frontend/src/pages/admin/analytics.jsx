    ...
    <div className="min-h-[calc(100dvh-4rem)] p-3.5 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6 sm:space-y-8 bg-ambient-mesh selection:bg-sky-500 selection:text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="glass-panel-elevated p-6 rounded-3xl border border-white/[0.12] space-y-5 shadow-glass-md glass-card-emerald hover:shadow-glow-emerald transition-all">
          ...
          <div className="space-y-2.5">
            <div className="flex justify-between text-xs py-1 border-b border-white/[0.06]">
              <span className="text-slate-400">Vector Search P95</span>
              <span className="font-mono text-emerald-400 font-bold">&lt; 45 ms</span>
            </div>
            <div className="flex justify-between text-xs py-1 border-b border-white/[0.06]">
              <span className="text-slate-400">LLM Inference Mode</span>
              <span className="font-mono text-sky-400 font-bold">Gemini 2.0 Flash / OpenAI</span>
            </div>
            <div className="flex justify-between text-xs py-1">
              <span className="text-slate-400">Source Citations</span>
              <span className="font-mono text-white font-bold">Automatic Exact Page Extraction</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="glass-panel-elevated p-6 sm:p-8 rounded-3xl border border-white/[0.12] space-y-6 shadow-glass-lg">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs font-mono font-bold text-sky-400 glass-badge px-3 py-1 rounded-full">
              ...
              return (
                <div key={cat} className="space-y-1.5">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-mono text-sky-400 font-bold">{count} chunks</span>
                  </div>
                  <div className="w-full bg-slate-900 rounded-full h-3 overflow-hidden border border-white/[0.05] p-0.5">
                    <div
                      className="h-full rounded-full bg-gradient-to-r from-sky-500 via-indigo-500 to-purple-500 shadow-glow-blue transition-all duration-700"
